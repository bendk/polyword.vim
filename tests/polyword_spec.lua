...
describe("case transforms", function()
    ...
    it("works with a single word", function()
        assert.equals("abc", run_transform("camel", "abc", 1))
        assert.equals("Abc", run_transform("pascal", "abc", 1))
        assert.equals("abc", run_transform("kebab", "abc", 1))
        assert.equals("abc", run_transform("snake", "abc", 1))
        assert.equals("ABC", run_transform("snake-upper", "ABC", 1))
    end)
end)
